...
class DioLogger extends Interceptor {
  ...
  @override
  void onResponse(
    Response<DioResponseType> response,
  ...
  void _printResponse(Response<DioResponseType> response) {
  ...
  void _printResponseHeader(Response<DioResponseType> response) {
  ...
  void _printList(List<DioResponseType> list, {int tabs = initialTab}) {
